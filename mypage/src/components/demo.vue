 ...
 <div id="app"> 
    <el-container> 
        <el-header height="90px"> 
            <h4 style="margin-left:70%;margin-bottom:5px">欢迎</h4>
            <el-dropdown style="margin-left:80%;" @command="handleCommand">
            ...
            <el-tabs v-model="activeName">
                <el-tab-pane label="分类管理" name="first">
                    <el-button type="text" @click="dialogFormVisible = true">增加分类</el-button>
                        ...
                        <el-col :span='18' class="col1" style="margin-left:10%;" >
                        ...
                        <br>
                        <br>
                        <el-col :span='18' class="col2" style="margin-left:10%;margin-top:20px">
                        ...
                        <br>
                        <br>
                        <!-- <el-button type='success' @click='insert'>确认添加</el-button> -->
                    </form>
                ...
                <el-tab-pane label="增加分类" name="second">
                        <el-row> 
                    <form style="text-align: center;">
                        <el-col :span='12' class="col1" style="margin-left:25%;margin-top:40px" >
                            <el-input type="text" placeholder="请输入编号" v-model="id">
                                <template slot="prepend">编号：</template>
                            </el-input>
                        </el-col>
                        ...
                        <br>
                        <br>
                        <el-col :span='12' class="col2" style="margin-left:25%;margin-top:20px">
                            <el-input type="text" placeholder="请输入类名" v-model='name'>
                                <template slot="prepend">类名：</template>
                            </el-input>
                        </el-col>
